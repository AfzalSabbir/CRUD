...
class Widget extends Fluent
{
    ...
    public function getFinalViewPath()
    {
        ...
        if (! backpack_pro()) {
            throw new BackpackProRequiredException('Cannot find the widget view: '.$this->type.'. Please check for typos.'.(backpack_pro() ? '' : ' If you are trying to use a PRO widget, please first purchase and install the arsbs23/pro addon from backpackforlaravel.com'), 1);
        }
